...
def normalizeStaining(tile, saveFile=None, Io=240, alpha=1, beta=0.15):
	...
	# Reference values for normalization (can also select a representative tile to use for these files.)       
...
def normalizeStaining_nosave(tile, saveFile=None, Io=240, alpha=1, beta=0.15):
	''' Normalize staining appearence of H&E stained images
